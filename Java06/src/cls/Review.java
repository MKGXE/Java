...
public class Review {
	public static void main(String[] args) {
		...
		// 객체화
		// 클래스명 변수명 = new 클래스명();
		MyModel1 mm = new MyModel1();		// 다른 클래스의 변수나 메서드를 사용하려면 '객체화'를 해줘야함
		MyModel1 mm2 = new MyModel1();		// 객체가 다르면 형태는 같지만 변수가 다름(다른 공간)
		String str = "안녕";
		String str2 = "반갑";
...
class MyModel1{
	...
	// 메서드
	// 1. num변수에 값을 넣기
	void setNum(int num) {		// ()에 변수가 있으니깐 사용할 때 대입이 될것이다
...
// 출력용 (화면, 소리, ...)
class MyView{
	void printNum(MyModel1 mm) {
		System.out.println(mm.num);
	}
	
	void printStr(MyModel1 mm) {
